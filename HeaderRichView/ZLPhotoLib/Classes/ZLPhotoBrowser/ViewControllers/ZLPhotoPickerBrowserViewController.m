...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (self.photos.count) {
        ...
        if (photo.isVideo) {
            ...
            videoBtn.center = CGPointMake(scrollBoxView.width * 0.5, scrollBoxView.height * 0.5);
...
- (void)changeRotationDirection:(NSNotification *)noti{
    ...
    flowLayout.minimumLineSpacing = 0;
    flowLayout.minimumInteritemSpacing = 0;
    flowLayout.itemSize = CGSizeMake(self.view.size.width + ZLPickerColletionViewPadding, self.view.height);
    flowLayout.scrollDirection = UICollectionViewScrollDirectionHorizontal;
