...
- (void)setPhoto:(ZLPhotoPickerBrowserPhoto *)photo{
    ...
    if (photo.photoURL.absoluteString.length) {
        ...
        if (photoRange.location != NSNotFound){
            ...
            // 网络URL
//            [_photoImageView sd_setImageWithURL:photo.photoURL placeholderImage:thumbImage options:EMSDWebImageRetryFailed progress:^(NSInteger receivedSize, NSInteger expectedSize) {
